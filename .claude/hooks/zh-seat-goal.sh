...
repeatedly, in different ways, to reserve the seat. Do NOT attempt the website or the app
yourself - both are broken for this ticket. Tautologies (以实际为准) are not answers.
